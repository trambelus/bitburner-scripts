...
const argsSchema = [ // The set of all command line arguments
  ...
  ['no-crime-training', true], // Set to true to pass the `--no-crime-training` flag to `work-for-factions.js`.
  ['no-crime', false], // Set to true to pass the `--no-crime` flag to `work-for-factions.js`.
